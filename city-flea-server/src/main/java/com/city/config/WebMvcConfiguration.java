...
import com.city.interceptor.JwtTokenAdminInterceptor;
import com.city.interceptor.JwtTokenRiderInterceptor;
import com.city.interceptor.JwtTokenUserInterceptor;
import com.city.json.JacksonObjectMapper;
...
public class WebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    protected void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(jwtTokenRiderInterceptor)
                ...
                .excludePathPatterns("/rider/auth/login", "/rider/auth/register");
    }
